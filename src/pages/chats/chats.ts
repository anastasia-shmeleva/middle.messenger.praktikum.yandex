...
const main = new Main({
  ...
  chatPreview2: new ChatPreview({ 
    avatar: "https://avatars.dicebear.com/api/adventurer-neutral/mail%40ashallendesign.co.uk.svg",
    name: "Andy", 
  ...
  chatPreview3: new ChatPreview({ 
    avatar: "https://joeschmoe.io/api/v1/mail@ashallendesign.co.uk",
    name: "Dan", 
    message: "Cool!", 
    time: "Fri", 
    quantity: "",
  ...
  chat: new Chat({ 
    stub: "Choose chat to send a message",
    empty: false,
    avatar: "https://joeschmoe.io/api/v1/mail@ashallendesign.co.uk",
    currentChatName: "Dan",
  }),
