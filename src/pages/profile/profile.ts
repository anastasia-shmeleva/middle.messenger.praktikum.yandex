...
const profile = new Profile({
  ...
  confirmPassword: new ProfileField({ label: "Confirm password", type: "password", value: "somepassword", name: "confirmPassword", edit: true }),
  avatar: new Avatar({ 
  ...
  button: new Button({ name: "Save" }),
  profileChange: new Action({
    link: "",
    name: "Edit details ",
    events: {
      click: (e) => {
