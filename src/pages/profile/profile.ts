...
export default class Profile extends Block<Props> {
  ...
  init(): void {
    ...
    this.children.firstName = new ProfileField({ label: "Name", type: "text", value: "Ivan", name: "firs_name", edit: false });
    this.children.secondName = new ProfileField({ label: "Second name", type: "text", value: "Ivanov", name: "second_name", edit: false });
    this.children.displayName = new ProfileField({ label: "Display name", type: "text", value: "Ivan", name: "display_name", edit: false });
    this.children.phone = new ProfileField({ label: "Phone", type: "phone", value: "+44 999 999 99 99", name: "phone", edit: false });
    this.children.oldPassword = new ProfileField({ label: "Old password", type: "password", value: "password", name: "oldPassword", edit: true });
    this.children.newPassword = new ProfileField({ label: "New Password", type: "password", value: "somepassword", name: "newPassword", edit: true });
    this.children.confirmPassword = new ProfileField({ label: "Confirm password", type: "password", value: "somepassword", name: "confirmPassword", edit: true });
    ...
    this.children.button = new Button({ name: "Save" });
